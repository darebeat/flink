package org.darebeat.common.utils;
...
import org.darebeat.common.schemas.MetricSchema;
...
import static org.darebeat.common.constant.PropertiesConstants.*;
...
public class KafkaConfigUtil {
    ...
    public static DataStreamSource<MetricEvent> buildSource(StreamExecutionEnvironment env) throws IllegalAccessException {
        ...
        String topic = parameter.getRequired(METRICS_TOPIC);
